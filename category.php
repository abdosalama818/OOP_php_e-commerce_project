...
$category_a = $category->selectId($id, "name");
echo "ddddddddddddddddddd";

$product_object = new Products;
$pr = $product_object->selectAll();
$products = $product_object->selectWhere("cat_id=$id", "id,name,img,price");
//print_r($pr);
//echo " ------------------------------";
//print_r($products);
							...
							<div class="product_item">
								...
								<div class="product_content">
									...
									<div class="product_name">
										<div><a href="product.php?id=<?= $prod['id']; ?>" tabindex="0"><?= $prod['name']; ?></a></div>
									</div>
								</div>
